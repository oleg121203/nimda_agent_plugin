"""
Configuration for chat_agent component
Configuration and settings for chat_agent

This configuration file defines all settings and parameters for the chat_agent component.
"""
...
class ChatAgentConfig:
    """Configuration class for chat_agent component."""
    
    # Component identification
    component_name: str = "chat_agent"
    version: str = "1.0.0"
    ...
    def from_env(cls) -> "ChatAgentConfig":
        ...
        return cls(
            component_name=os.getenv("COMPONENT_NAME", "chat_agent"),
    ...
    @classmethod
    def from_dict(cls, config_dict: Dict[str, Any]) -> "ChatAgentConfig":
...
def get_config(config_source: Optional[str] = None) -> ChatAgentConfig:
    """
    ...
    if config_source == "env":
        return ChatAgentConfig.from_env()
