...
class NIMDAPluginSystemRunner:
    ...
    def __init__(self, workspace_path: str = "."):
        ...
        self.plugin_manager = PluginManager(
            plugins_dir=str(Path(__file__).parent / "plugins"), max_workers=4
        )

        # Налаштування зворотних викликів
        self.plugin_manager.on_plugin_loaded = self._on_plugin_loaded
        self.plugin_manager.on_plugin_error = self._on_plugin_error
